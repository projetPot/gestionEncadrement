...
<html>
	...
	<body style=" height: 850px;" >
		...
		<div id="nom" style="visibility: hidden;" >
			<div  id="ferm" style="height: 25px; " > <?php echo '<img style=\' width: 30px; height: 100%;\' src=../avatar/'.$_SESSION['photo'].' /> <span style=\'position: absolute; top: 1px; left: 15%; \' > <b>'.$_SESSION['name'] ?> & <span id="user">user</span></span> </b> <img src="../images/bas.png" width="20" style="position: absolute; right: 20px;" onclick="masq();" /><img src="../images/close.png" style="position: absolute; right: 0px;" onclick="arret();" /> </div>
		...
		<p id="ouv"  style=" height: 25px; visibility: hidden;" > <?php echo '<img style=\' width: 30px; height: 100%;\' src=../avatar/'.$_SESSION['photo'].' /> <b>'.$_SESSION['name'] ?> </b> & <span id="user">user</span> <img src="../images/haut.png" width="20" style="position: absolute; right: 20px;" onclick="aff();" /><img src="../images/close.png" style="position: absolute; right: 0px;" onclick="arret();" /></p>
		<div id="triangle"></div>
